...
//
//  RULE 1 · X-Value AI → Manager
//    Rate : 3% of the closing_amount (one-time payment)
//    Who  : assigned_manager_id on the contract
//    When : payment_month = 1 (the single AI payment)
//    Note : This covers ALL sales generated by the manager's team — any X-Value AI
//           contract activated with this manager assigned triggers their 3% commission.
//
//  RULE 2 · X-VALUE GROWTH → Comercial (Sales)
//    Rate : 10% of fee_month_1_2 per month
//    Who  : assigned_sales_id on the contract
//    When : payment_month IN (1, 2) only
//
//  RULE 3 · X-VALUE GROWTH → Manager
//    Rate : 10% of fee_month_3_plus per month
//    Who  : assigned_manager_id on the contract
//    When : payment_month IN (3, 4) only
//
//  DB note: `payment_month` (integer ≥ 1) is stored on both `payments` and
//  `commissions` tables, making month-based commission eligibility unambiguous.
// ═══════════════════════════════════════════════════════════════════════════════
const AI_MANAGER_RATE        = 0.03 as const;  // Rule 1 — 3%
const GROWTH_SALES_RATE      = 0.10 as const;  // Rule 2 — 10%
const GROWTH_MANAGER_RATE    = 0.10 as const;  // Rule 3 — 10%
const GROWTH_SALES_MONTHS    = [1, 2]          as const;  // Rule 2 months
const GROWTH_MANAGER_MONTHS  = [3, 4]          as const;  // Rule 3 months
