    ...
    <main className="min-h-screen bg-[#05010d] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex justify-center mb-2">
          <Image src="/logo.png" alt="X-Value" width={120} height={30} style={{ height: '30px', width: 'auto' }} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {error && (
            <p className="text-red-400 text-sm leading-relaxed">
              Usuario o contraseña incorrectos. Por favor, contacta a soporte.
            </p>
          )}

          <button
            type="submit"
            className="w-full rounded-lg py-3 text-sm font-semibold text-black transition-opacity hover:opacity-90 mt-1"
            style={{
        ...
        <p className="text-center text-white/20 text-xs">
          ...
          <a href="mailto:soporte@xvalueai.com" className="text-white/40 hover:text-white/60 transition-colors underline">
            Contacta a soporte
          </a>
        </p>
      </div>
