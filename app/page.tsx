  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-transparent">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(3,1,18,0.88) 0%, rgba(3,1,18,0.35) 55%, rgba(3,1,18,0.1) 100%)",
          zIndex: 1,
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 65% 30%, rgba(0,192,243,0.07) 0%, transparent 55%)",
          zIndex: 1,
        }}
      />
      ...
      <div className="relative z-10 min-h-screen flex flex-col bg-transparent">
        ...
        >
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <motion.button
              ...
              className="flex items-center gap-1.5 text-xs font-bold px-4 py-2 rounded-lg text-black transition-all"
        ...
        <div className="flex-1 flex items-end justify-center md:justify-start pt-16 pb-12 px-6 md:px-12">
          <div className="w-full max-w-[440px] flex flex-col items-center md:items-start text-center md:text-left">
            ...
            {/* Headline */}
            <motion.h1
              className="text-5xl md:text-6xl text-white leading-[1.05] mb-4"
              style={{
            ...
            {/* Description — new Silicon Valley copy */}
            <motion.p
            ...
            {/* Glassmorphic card → routes to /plataforma */}
            <motion.div
